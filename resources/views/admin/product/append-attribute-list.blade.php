        ...
        <div class="row g-2">
            ...
            <div class="col mb-0">
                <div class="form-group">
                    ...
                    <input onclick="enableProductStoreBtn()" type="text" name="price[]" class="form-control" placeholder="Product Price" required>
                </div>
            </div>
            <div class="col mb-0">
                <div class="form-group">
                    <label>Discount Price</label>
                    <input type="text" name="discount[]" class="form-control" placeholder="Discount Price"
                    required>
                </div>
            </div>
            <div class="col mb-0">
            ...
            <div class="col mb-0">
                <div class="form-group">
                    ...
                    <input type="file" name="variation_img[]" accept="image/*" class="form-control" placeholder="" required>
                </div>
            </div>
        </div>
    @endfor
