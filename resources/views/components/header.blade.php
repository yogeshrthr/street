...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../backend/vendors/images/favicon.png" />
</head>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <h3 class="" style="margin-top:14px;">Street Bolt</h3>
        <a class="navbar-brand brand-logo-mini" href="#"><img src="https://demo.bootstrapdash.com/libertyui/template/images/logo-mini.svg" alt="logo"/></a>
      </div>
